            ...
            <div className="bg-card rounded-2xl shadow-xl p-6 max-w-md w-full relative">
                ...
                {!result ? (
                    <form onSubmit={handleVerify} className="mt-6 space-y-4">
                        <p className="text-muted-foreground text-center text-sm">Enter the ticket code to verify its authenticity.</p>
                        <div>
            ...
            <aside className="lg:col-span-1 space-y-8">
                ...
                <div className="bg-card rounded-2xl shadow-lg shadow-gray-200/50 dark:shadow-none p-6 border border-border">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div>
                            <h3 className="font-bold text-lg text-card-foreground">Scan & Verify Tickets</h3>
                            <p className="text-sm text-muted-foreground mt-1">Verify attendee tickets for any event.</p>
                        </div>
                        <button
