...
const CustomTooltip: React.FC<any> = ({ active, payload, label }) => {
  if (active && payload && payload.length) {
    return (
      <div className="p-4 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-lg shadow-gray-200/50 dark:shadow-none">
        <p className="font-bold text-gray-900 dark:text-gray-200">{label}</p>
        {payload.map((pld: any) => (
