...
import { 
    ...
    ChartBarIcon, ShieldCheckIcon, Cog6ToothIcon
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <main className="lg:col-span-2 space-y-8">
                <div>
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-400">Complete overview of system performance and statistics.</p>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Link 
                            to="/admin/users" 
                            className="bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex justify-between items-center group transform hover:-translate-y-0.5"
                        >
                            <div>
                                ...
                                <p className="text-sm text-blue-100">View, edit, and manage user roles and permissions</p>
                            </div>
                            <ArrowRightIcon className="h-6 w-6 text-white group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link 
                            to="/manage-events" 
                            className="bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex justify-between items-center group transform hover:-translate-y-0.5"
                        >
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-sm text-purple-100">Create, edit, and manage all events in the system</p>
                            </div>
                            <ArrowRightIcon className="h-6 w-6 text-white group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link 
                            to="/scan" 
                            className="bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex justify-between items-center md:col-span-2 group transform hover:-translate-y-0.5"
                        >
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                All systems operational. {stats.users > 0 && `${stats.users} active users, `}
                                {stats.events > 0 && `${stats.events} events, `}
                                {stats.tickets > 0 && `${stats.tickets} tickets sold.`}
                            </p>
                        </div>
                    </div>
                </div>
